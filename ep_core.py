...
class _PluginAPI:
    ...
    def register_math_evaluator(self, name, eval_fn, priority=100):
        """Register a math expression evaluator (from plugins/lure, fentclient, etc).
...
IDENTITY_DIR = PROJECT_DIR / ".e_identity"
...
def create_identity(name, social=None):
...
def save_identity_public_key(name, pub_hex):
