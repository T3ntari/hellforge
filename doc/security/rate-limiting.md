...
The Piano DSL client enforces rate limits on outgoing requests to the oshonet.in server:

| Endpoint | Limit | Window |
|---|---|---|
| `/e_identity/submit` | 3 requests | 60 seconds |
| `/e_identity/review` | 10 requests | 60 seconds |
