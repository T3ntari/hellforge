...
| **Async** | [Async Compile](async/overview.md) · [LURE Async](async/lure-async.md)  · [Radical Async](async/radical-async.md) |
...
| **Verification** | local SHA-256 integrity + opt-in private registry (HF_VERIFY_URL) — see tools/verify_integrity.py |
