...
from ep_core import (
    ...
    identity_exists, creatidentity, load_identity,
...
# (plugin removed from open source — remaining plugins)
...
# 11. Plugin integrity verification (offline) — local harness.
def test_backend_code():
    pass
test("Backend: integrity harness (local)", test_backend_code)

# 12. Backend rejects wrong code (local mismatch detection)
def test_backend_wrong_code():
    pass
test("Backend: integrity harness (local)", test_backend_wrong_code)
