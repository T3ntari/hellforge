...
def _generate_lessons():
    ...
    m6 = [
        ...
        ("Ecosystem summary",
         ...
         "HELLFORGE v1.0.0.0 ALPHA is ready. Upload and compose!"),
    ]
...
def _generate_param_lessons():
    ...
    project_lessons = [
        ...
        ("Package distribution",
         ...
         "// plugin install myplugin\n// pkglist update — sync registry (HF_REGISTRY)",
        ...
        ("Plugin signing",
         ...
         "from ep_core import sign_file, savidentity_public_key\nsign_file('myplugin.py', author='MyName')\nsavidentity_public_key('MyName', my_public_key_hex)",
